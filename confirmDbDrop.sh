...
# Function to prompt the user for y or n
confirm() {
  echo "${YELLOW}NOTE${COLOR_RESET}: other programs/services cannot be currently using the database. 
  Please stop other uses of the database before trying to delete it."
  echo ""
    while true; do
