...
export default {
  ...
  theme: {
    extend: {
      dropShadow: {
        "0md": "0px -0px 1.8px rgba(0, 0, 0, 0.35)",
        "1md": "1px -1px 1.8px rgba(0, 0, 0, 0.35)",
        "2md": "2px -2px 1.8px rgba(0, 0, 0, 0.35)",
        "3md": "3px -3px 1.8px rgba(0, 0, 0, 0.35)",
        "4md": "4px -4px 1.8px rgba(0, 0, 0, 0.35)",
        "5md": "5px -5px 1.8px rgba(0, 0, 0, 0.35)",
        "6md": "6px -6px 1.8px rgba(0, 0, 0, 0.35)",
        "7md": "7px -7px 1.8px rgba(0, 0, 0, 0.35)",
        "8md": "8px -8px 1.8px rgba(0, 0, 0, 0.35)",
        "9md": "9px -9px 1.8px rgba(0, 0, 0, 0.35)",
