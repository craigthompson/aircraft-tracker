...
const socketConfig = {
  ...
  // SOCKET_DEV_URL_DOMAIN: `http://192.168.1.243`, // At office IP. TODO: can remove this later if wanted
  // SOCKET_DEV_URL_DOMAIN: `192.168.10.184`, // At home IP. TODO: can remove this later if wanted
};
